...
{
    public static IMachine Create<TFeedback>(INetwork network, GetFeedbackDelegate<TFeedback> getFeedback)
    {
        return new Machine(network, (latestOutput, clock) => (IFeedback?)getFeedback(latestOutput, clock));
    }
