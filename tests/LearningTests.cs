...
public class LearningTests
{
    ...
    public void Network_can_change_to_output_zero()
    {
        ...
        var network = INetwork.Create(new INeuronType[] { NeuronTypes.AlwaysOn, NeuronTypes.NoRetention }.Select(INeuron.Create).ToList(), outputCount: 1, getAxonConnection, IClock.Create(100));
